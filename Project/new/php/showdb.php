...
$sql= "SELECT * FROM  meals  order by orderNumber desc LIMIT 300" ;
$result = mysqli_query($conn, $sql);
if (mysqli_num_rows($result) > 0) {
         // output data of each row
      $HostName=$_GET['HostName'];
      echo "<table border='1' cellpadding='10'>";
      echo "<tr><th>orderNumber</th><th>mealName</th><th>price</th> <th>orderTime </th><th>deleveryTime</th><th>containerName</th> <th>serverAdress </th></tr>";
